...
DeepSeek Harness `0.1.2-alpha.4` 为准。`docs/technical-implementation-plan.md`
...
- Git 子模块已固定到 `dsh-v0.1.2-alpha.4`，npm registry 也已提供
  `@deepseek-ai/dsh@0.1.2-alpha.4` 及同版本运行时闭包。2026-09-02 已本地通过 shrinkwrap、
...
```json
{
  ...
  "dependencies": {
    ...
    "@deepseek-ai/dsh-base": "0.1.2-alpha.4",
